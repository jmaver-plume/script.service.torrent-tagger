...
class TestLinker(unittest.TestCase):
    def test_should_create_new_directories_and_link_files(self):
        ...
        self.assertTrue(os.path.islink(f'{movies_path}/Glass Onion A Knives Out Mystery (2022)/Glass Onion A Knives Out Mystery (2022).mp4'))
